  ...
  : Node("cyberdog_bringup_test")
  {
    ...
    INFO_STREAM(
      "当前 options 信息:" <<
        ...
        "\nget_rcl_node_options()->use_global_arguments = " <<
        options.get_rcl_node_options()->use_global_arguments
    );
    ...
    //     // print_usage();
    //     // TODO(ivanpauno)：
    // 更新 rclcpp_components 模板以能够处理异常。 在这里举一个，所以堆栈展开优雅地发生。
    //     std::exit(0);
    //   }
    ...
    // }
    // 申明 node.yaml 配置参数
    this->declare_parameter("simulator", std::vector<std::string>{});
    ...
    this->get_parameter(
      "cyberdog_bringup_test_parameter_int0",
      this->_include_cyberdog_bringup_test_parameter_int0);
    this->get_parameter(
      "cyberdog_bringup_test_parameter_int1",
      this->_include_cyberdog_bringup_test_parameter_int1);
    this->get_parameter(
      "cyberdog_bringup_test_parameter_int2",
      this->_include_cyberdog_bringup_test_parameter_int2);
    this->get_parameter(
      "cyberdog_bringup_test_parameter_int3",
      this->_include_cyberdog_bringup_test_parameter_int3);
    // 加载 cyberdog_bringup 包下 配置参数
    this->get_parameter(
      "cyberdog_bringup_parameter_int0",
      this->_include_cyberdog_bringup_parameter_int0);
    this->get_parameter(
      "cyberdog_bringup_parameter_int1",
      this->_include_cyberdog_bringup_parameter_int1);
    this->get_parameter(
      "cyberdog_bringup_parameter_int2",
      this->_include_cyberdog_bringup_parameter_int2);
    this->get_parameter(
      "cyberdog_bringup_parameter_int3",
      this->_include_cyberdog_bringup_parameter_int3);
    this->get_parameter(
      "parameter.parameters_bool",
      this->_include_cyberdog_bringup_parameters_bool);
    this->get_parameter("parameter.parameters_int", this->_include_cyberdog_bringup_parameters_int);
    this->get_parameter(
      "parameter.parameters_double",
      this->_include_cyberdog_bringup_parameters_double);
    this->get_parameter(
      "parameter.parameters_string0",
      this->_include_cyberdog_bringup_parameters_string0);
    this->get_parameter(
      "parameter.parameters_string1",
      this->_include_cyberdog_bringup_parameters_string1);
    this->get_parameter(
      "parameter.parameters_string2",
      this->_include_cyberdog_bringup_parameters_string2);
    this->get_parameter(
      "parameter.vector.parameters_bool_vector",
      this->_include_cyberdog_bringup_parameters_bool_vector);
    this->get_parameter(
      "parameter.vector.parameters_int_vector",
      this->_include_cyberdog_bringup_parameters_int_vector);
    this->get_parameter(
      "parameter.vector.parameters_double_vector",
      this->_include_cyberdog_bringup_parameters_double_vector);
    this->get_parameter(
      "parameter.vector.parameters_string_vector",
      this->_include_cyberdog_bringup_parameters_string_vector);
    ...
    this->info_vector("simulator", this->_simulator);
    ...
    INFO_STREAM(
      "cyberdog_bringup 包下 配置参数" <<
        ...
        this->_include_cyberdog_bringup_parameters_bool <<
        "\nparameter.parameters_int = " <<
        this->_include_cyberdog_bringup_parameters_int <<
        "\nparameter.parameters_double = " <<
        this->_include_cyberdog_bringup_parameters_double <<
        "\nparameter.parameters_string0 = " <<
        this->_include_cyberdog_bringup_parameters_string0 <<
...
private:
  std::vector<std::string> _simulator;    // 需要开启模拟器模式的对象
  ...
  double _include_cyberdog_bringup_parameters_double {0.};  // float 参数
  // string 键值对(单string):无引号方式约束
  std::string _include_cyberdog_bringup_parameters_string0 {""};
  // string 键值对(多string):单引号方式约束
  std::string _include_cyberdog_bringup_parameters_string1 {""};
  // string 键值对(多string):双引号方式约束
  std::string _include_cyberdog_bringup_parameters_string2 {""};
  // bool 键值对(数组)
  std::vector<bool> _include_cyberdog_bringup_parameters_bool_vector;
  // int 键值对(数组)
  std::vector<int64_t> _include_cyberdog_bringup_parameters_int_vector;
  // double 键值对(数组)
  std::vector<double> _include_cyberdog_bringup_parameters_double_vector;
  // string 键值对(数组)
  std::vector<std::string> _include_cyberdog_bringup_parameters_string_vector;
