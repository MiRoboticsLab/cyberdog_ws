...
colcon build --merge-install --install-base /opt/ros2/cyberdog --parallel-workers 40  --packages-skip cyberdog_gridmap_costmap_plugin navigation_bringup navigation_interfaces
