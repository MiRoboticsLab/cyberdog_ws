...
colcon build --merge-install --install-base /opt/ros2/cyberdog --parallel-workers 40

echo -n "get commit id sum of all repos"
cd /
git clone git@git.n.xiaomi.com:MiRoboticsLab/os/toolbox/carpo_deb_repos.git
